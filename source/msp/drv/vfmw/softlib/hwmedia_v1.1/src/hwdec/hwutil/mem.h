...
#else
typedef void* funAVMalloc(void *ptr, unsigned int len);
#endif
extern funAVMalloc* av_malloc_hw;
#define AV_MALLOC_FUNCTION(fun) {if(av_malloc_hw != fun) av_malloc_hw = fun;}

typedef void  funAVFree(void *ptr);
