...
* Date: $2007/03/1$
* Revision: $v1.0$
* Purpose: mpeg4 decoder header file
*
*
* Change History:
*
* Date             Author            Change
* ====             ======            ====== 
* 2007/03/08       l42896 & l48485              Original
*
* Dependencies:
*
************************************************************************/
...
#define MP4_PIC_OK                             (MP4_FOUND_VOPHDR|MP4_FOUND_SLCHDR|MP4_FOUND_NEXTVOPHDR|MP4_FOUND_NVOP)
...
SINT32 MPEG4DEC_VDMPostProc(MP4_CTX_S *pCtx, SINT32 ErrRatio);
