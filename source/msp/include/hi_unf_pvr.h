...
typedef struct hiUNF_PVR_REC_STATUS_S
{
    ...
    HI_U32                      u32Reserved;             /**<Reserved, for alignment*//**<CNcomment: 保留，用作对齐。    */
    HI_U64                      u64CurWritePos;          /**<Size of the currently recorded file, in byte*//**<CNcomment: 当前录制文件的大小（单位：byte）。 */
...
typedef enum hiUNF_PVR_PLAY_SPEED_E
{
    ...
    HI_UNF_PVR_PLAY_SPEED_64X_FAST_FORWARD  = 64 * HI_UNF_PVR_PLAY_SPEED_NORMAL,        /**<Fast forward at 64 times the normal speed*//**<CNcomment:32倍速快放。           */
    HI_UNF_PVR_PLAY_SPEED_1X_FAST_BACKWARD  = -1 * HI_UNF_PVR_PLAY_SPEED_NORMAL,        /**<Fast backward at 1 times the normal speed*//**<CNcomment:2倍速快退。            */
    ...
    HI_UNF_PVR_PLAY_SPEED_64X_FAST_BACKWARD = -64 * HI_UNF_PVR_PLAY_SPEED_NORMAL,       /**<Fast backward at 64 times the normal speed*//**<CNcomment:32倍速快退。           */
