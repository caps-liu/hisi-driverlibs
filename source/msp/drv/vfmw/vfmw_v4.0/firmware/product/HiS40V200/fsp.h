...
#define TREE_HD_1_NUM                 8  //10//8+2  原来为10的，但是内存不够，所以设为8
#define TREE_PMV_NUM                  17
#define TREE_MAX_DISP_NUM             20
...
typedef struct hiFSP_INST_S
{
	...
	SINT32            PmvAddr[MAX_PMV_SLOT_NUM]; //20
...
typedef struct TREE_FSP_INST_S
{
    ...
    SINT32           s32HalfPmvOffset;
    SINT8             IsPmvInUse[TREE_PMV_NUM];                    // 指示PMV 帧存是否可用           
