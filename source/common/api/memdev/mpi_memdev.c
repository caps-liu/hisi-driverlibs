...
HI_S32 MPI_MEMDEV_MapRegister(HI_U32 u32RegAddr, HI_U32 u32Length, HI_VOID *pVirAddr)
{
    ...
    /* map */
    pu32MapAddr = (HI_U32 *)mmap(HI_NULL_PTR, u32Length+u32SubAddr, 
            PROT_READ|PROT_WRITE, MAP_SHARED, g_stMemdevParam.s32Fd, (long)u32PageAddr);
    if (pu32MapAddr == MAP_FAILED)
    {
        MEMDEV_UNLOCK(g_stMemdevParam.stMutex);
    ...
    pstMapNode->pActualVirAddr = (HI_VOID*)pu32MapAddr;
    *((HI_U32*)pVirAddr) = (HI_U32)pu32MapAddr + u32SubAddr;
    pstMapNode->pVirAddr = (HI_VOID*)(*((HI_U32*)pVirAddr));
