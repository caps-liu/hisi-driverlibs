...
HI_VOID                 HAL_AIAO_P_GetBorardTxI2SDfAttr(HI_U32 u32BoardI2sNum,
                                                                     HI_UNF_I2S_ATTR_S  *pstI2sAttr,
                                                                     AIAO_PORT_ID_E *penPortID,
                                                                     AIAO_PORT_USER_CFG_S *pAttr);
HI_VOID                 HAL_AIAO_P_GetBorardRxI2SDfAttr(HI_U32 u32BoardI2sNum,
                                                                     HI_UNF_I2S_ATTR_S  *pstI2sAttr,
                                                                     AIAO_PORT_ID_E *penPortID,
                                                                     AIAO_PORT_USER_CFG_S *pAttr);
HI_S32                  HAL_AIAO_P_CheckBorardI2SOpenAttr(AIAO_PORT_ID_E enPortID,
                                                                       const AIAO_IfAttr_S     *pstNewIfAttr);
HI_VOID                 HAL_AIAO_P_CrateBorardI2SOpenAttr(AIAO_PORT_ID_E enPortID,
                                                                       const AIAO_IfAttr_S     *pstNewIfAttr);
