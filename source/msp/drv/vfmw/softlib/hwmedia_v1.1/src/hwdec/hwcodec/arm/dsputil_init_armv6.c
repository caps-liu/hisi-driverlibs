...
extern vp56_edge_filter_armv6(uint8_t *yuv, int pix_inc, int line_inc, int t); 
extern vp6_filter_diag2_asm(uint8_t *dst, uint8_t *src, int stride, uint16_t* h_weight, uint16_t* v_weight);
extern twotap_vp6_asm_h(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int stride, uint16_t* filter);
extern twotap_vp6_asm_v(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int stride, uint16_t* filter);
