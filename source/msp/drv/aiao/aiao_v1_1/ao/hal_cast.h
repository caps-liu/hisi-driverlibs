...
//HI_S32					HAL_CAST_GetStatus(AIAO_CAST_ID_E enCast, HI_VOID *pstStatus);
...
HI_U32				    HAL_CAST_WriteData(AIAO_CAST_ID_E enCast, HI_U8 * pu32Src, HI_U32 u3SrcLen);
HI_U32				    HAL_CAST_GetDelayMs(AIAO_CAST_ID_E enCast, HI_U32 * pu32Delayms); 
