...
static const AVOption options[]={0
#if 0
...
{"channel_layout", NULL, OFFSET(channel_layout), FF_OPT_TYPE_INT64, DEFAULT, 0, (double)INT64_MAX, A|E|D, "channel_layout"},
{"request_channel_layout", NULL, OFFSET(request_channel_layout), FF_OPT_TYPE_INT64, DEFAULT, 0, (double)INT64_MAX, A|D, "request_channel_layout"},
...
//  s->sample_aspect_ratio= (AVRational){0,1};
	...
	/* 将sample_aspect_ratio的num的初始值设为1 */
