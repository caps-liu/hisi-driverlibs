...
#define  PNG_TRANSFORM_PREMULTI_ALPHA    0x200000
...
#ifdef HIPNG_ACCELERATE
   png_voidp private_ptr PNG_DEPSTRUCT;  
#endif
};
...
extern PNG_EXPORT(void, png_set_inflexion) PNGARG((png_structp png_ptr, 
...
#ifdef HIPNG_ACCELERATE
extern PNG_EXPORT(void, png_read_image_async) PNGARG((png_structp png_ptr, 
    png_bytepp image));
#endif
...
#ifdef HIPNG_ACCELERATE
extern PNG_EXPORT(void, png_read_png_async) PNGARG((png_structp png_ptr,
                        png_infop info_ptr,
                        int transforms,
                        png_voidp params));
#endif
