#ifndef __DRV_VI_REG_HI3716CV200ES_H__
#define __DRV_VI_REG_HI3716CV200ES_H__
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_3            : 15; // [30..16]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_6            : 14; // [15..2]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int int_ch1_en            : 1; // [1]
        unsigned int Reserved_9            : 14; // [15..2]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_11           : 30; // [30..1]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_13           : 9; // [14..6]
...
typedef union
{
    ...
    {
        unsigned int offset                : 6; // [5..0]
        unsigned int Reserved_15           : 9; // [14..6]
        unsigned int rev                   : 1; // [15]
        unsigned int mask                  : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_17           : 20; // [30..11]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_23           : 5; // [7..3]
        ...
        unsigned int Reserved_21           : 3; // [23..21]
        unsigned int field_sel             : 2; // [25..24]
        unsigned int field_inv             : 1; // [26]
        unsigned int Reserved_20           : 5; // [31..27]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_26           : 1; // [0]
        unsigned int hsync_mode            : 1; // [1]
        unsigned int vsync_mode            : 1; // [2]
        unsigned int Reserved_25           : 28; // [30..3]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_29           : 23; // [30..8]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_30           : 8; // [31..24]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_31           : 31; // [30..0]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_33           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_35           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_45           : 8; // [7..0]
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_50           : 31; // [30..0]
        unsigned int enable                : 1; // [31]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_53           : 30; // [31..2]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_55           : 22; // [29..8]
...
typedef union
{
    ...
    {
        unsigned int bitw                  : 8; // [7..0]
        unsigned int Reserved_57           : 22; // [29..8]
        unsigned int mode                  : 2; // [31..30]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_59           : 6; // [7..2]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_61           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_62           : 4; // [31..28]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int mirror                : 1; // [0]
        unsigned int flip                  : 1; // [1]
        unsigned int Reserved_64           : 6; // [7..2]
        unsigned int dis                   : 8; // [15..8]
        unsigned int buf_len               : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int height                : 16; // [15..0]
        unsigned int Reserved_66           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int stride                : 16; // [15..0]
        unsigned int Reserved_68           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_69           : 25; // [31..7]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_71           : 25; // [31..7]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_73           : 30; // [31..2]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_79           : 13; // [15..3]
        unsigned int height                : 2; // [17..16]
        unsigned int Reserved_78           : 14; // [31..18]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int width                 : 3; // [2..0]
        unsigned int Reserved_82           : 13; // [15..3]
        unsigned int height                : 2; // [17..16]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_83           : 30; // [31..2]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_86           : 16; // [31..16]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int hlratio               : 16; // [15..0]
        unsigned int Reserved_87           : 13; // [28..16]
...
typedef union
{
    ...
    struct
    {
        unsigned int hchratio              : 16; // [15..0]
        unsigned int Reserved_89           : 13; // [28..16]
...
typedef union
{
    ...
    struct
    {
        unsigned int hluma_offset          : 17; // [16..0]
        unsigned int Reserved_90           : 15; // [31..17]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int hchroma_offset        : 17; // [16..0]
        unsigned int Reserved_91           : 15; // [31..17]
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_92           : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int width                 : 13; // [12..0]
        unsigned int Reserved_93           : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int width                 : 13; // [12..0]
        unsigned int Reserved_94           : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int width                 : 13; // [12..0]
        unsigned int Reserved_95           : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_96           : 31; // [30..0]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int Reserved_99           : 11; // [15..5]
        unsigned int coef1                 : 5; // [20..16]
        unsigned int Reserved_98           : 11; // [31..21]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int Reserved_100          : 29; // [28..0]
...
typedef union
{
    ...
    {
        unsigned int width                 : 13; // [12..0]
        unsigned int Reserved_102          : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    {
        unsigned int width                 : 13; // [12..0]
        unsigned int Reserved_104          : 19; // [31..13]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int hl_coef0              : 10; // [9..0]
        unsigned int hl_coef1              : 10; // [19..10]
        unsigned int hl_coef2              : 10; // [29..20]
...
typedef union
{
    ...
    struct
    {
        unsigned int hl_coef3              : 10; // [9..0]
        unsigned int hl_coef4              : 10; // [19..10]
        unsigned int hl_coef5              : 10; // [29..20]
...
typedef union
{
    ...
    struct
    {
        unsigned int hl_coef6              : 10; // [9..0]
        unsigned int hl_coef7              : 10; // [19..10]
        unsigned int hl_coef8              : 10; // [29..20]
...
/* Define the union U_CH_LHFIR_COEF3 */
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int hl_coef9              : 10; // [9..0]
        unsigned int hl_coef10             : 10; // [19..10]
        unsigned int hl_coef11             : 10; // [29..20]
...
typedef union
{
    ...
    struct
    {
        unsigned int hch_coef0             : 10; // [9..0]
        unsigned int hch_coef1             : 10; // [19..10]
        unsigned int hch_coef2             : 10; // [29..20]
...
typedef union
{
    ...
    struct
    {
        unsigned int hch_coef3             : 10; // [9..0]
        unsigned int hch_coef4             : 10; // [19..10]
        unsigned int hch_coef5             : 10; // [29..20]
        unsigned int Reserved_112          : 2; // [31..30]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int hch_coef6             : 10; // [9..0]
        unsigned int hch_coef7             : 10; // [19..10]
        unsigned int hch_coef8             : 10; // [29..20]
        unsigned int Reserved_113          : 2; // [31..30]
    } bits;
...
/* Define the union U_CH_CHFIR_COEF3 */
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int hch_coef9             : 10; // [9..0]
        unsigned int hch_coef10            : 10; // [19..10]
        unsigned int hch_coef11            : 10; // [29..20]
        unsigned int Reserved_114          : 2; // [31..30]
    } bits;
...
typedef struct hiVI_REG_S
{
    ...
    volatile unsigned int          CH_DES_Y_FADDR;
    ...
    volatile unsigned int          Reserved_19[3];
    volatile U_CH_DES_C_CFG        CH_DES_C_CFG;
    volatile unsigned int          CH_DES_C_FADDR;
    ...
    volatile unsigned int          Reserved_20[3];
    ...
    volatile unsigned int          Reserved_23[2];
    ...
    volatile unsigned int          Reserved_25[54];
    ...
    volatile unsigned int          Reserved_27[58];
    ...
    volatile unsigned int          Reserved_29[52];
    volatile U_CH_VCDS_CFG         CH_VCDS_CFG;
    volatile U_CH_VCDS_COEF        CH_VCDS_COEF;
    volatile unsigned int          Reserved_30[62];
