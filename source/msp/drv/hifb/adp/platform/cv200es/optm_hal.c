...
#endif
volatile OPTM_S_VOU_V400_REGS_TYPE *pOptmVdpReg;
...
{
    pOptmVdpReg = (OPTM_S_VOU_V400_REGS_TYPE *)virAddr;

    pOptmVdpReg->CBM_ATTR.u32 = 0xCul;
}
...
HI_VOID  OPTM_VDP_GFX_GetLayerEnable(HI_U32 u32Data, HI_U32 *pu32Enable )
{
    ...
    GFX_CTRL.u32 = OPTM_VDP_RegRead((HI_U32)((HI_U32)&(pOptmVdpReg->G0_CTRL.u32) + u32Data * OPTM_GFX_OFFSET));
...
HI_VOID OPTM_VDP_GFX_SetGammaEnable(HI_U32 u32Data, HI_U32 u32GmmEn)
{
    ...
    G0_CTRL.u32 = OPTM_VDP_RegRead((HI_U32)((HI_U32)&(pOptmVdpReg->G0_CTRL.u32)+u32Data*OPTM_GFX_MAX));
    G0_CTRL.bits.gmm_en = u32GmmEn;
    OPTM_VDP_RegWrite((HI_U32)((HI_U32)&(pOptmVdpReg->G0_CTRL.u32)+u32Data*OPTM_GFX_MAX), G0_CTRL.u32);
}
...
HI_VOID OPTM_VDP_GFX_SetDofEnable(HI_U32 u32Data,HI_U32 bTrue)
{
    ...
    G0_DOFCTRL.u32 = OPTM_VDP_RegRead((HI_U32)((HI_U32)&(pOptmVdpReg->G0_DOFCTRL.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_DOFCTRL.bits.dof_en = bTrue ;
    OPTM_VDP_RegWrite((HI_U32)((HI_U32)&(pOptmVdpReg->G0_DOFCTRL.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DOFCTRL.u32);
}
...
HI_VOID OPTM_VDP_GFX_SetDofStep ( HI_U32 u32Data, HI_U32 u32eye_sel,HI_U32 u32step)
{
    ...
    if(u32eye_sel== 0)
    {
        ...
        G0_DOFSTEP.u32 = OPTM_VDP_RegRead((HI_U32)((HI_U32)&(pOptmVdpReg->G0_DOFSTEP.u32)+ u32Data * OPTM_GFX_OFFSET));

        G0_DOFSTEP.bits.left_eye = 0 ;
        G0_DOFSTEP.bits.left_step = u32step ;
        OPTM_VDP_RegWrite((HI_U32)((HI_U32)&(pOptmVdpReg->G0_DOFSTEP.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DOFSTEP.u32);
...
HI_VOID OPTM_VDP_GFX_SetDispMode(HI_U32 u32Data, OPTM_VDP_DISP_MODE_E enDispMode)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)((HI_U32)&(pOptmVdpReg->G0_CTRL.u32) + u32Data * OPTM_VID_OFFSET), G0_CTRL.u32); 
...
HI_VOID OPTM_VDP_GP_SetDispMode(HI_U32 u32Data, OPTM_VDP_DISP_MODE_E enDispMode)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)((HI_U32)&(pOptmVdpReg->GP0_CTRL.u32) + u32Data * OPTM_VID_OFFSET), GP0_CTRL.u32); 
...
HI_VOID  OPTM_VDP_WBC_SetParaUpd (OPTM_VDP_LAYER_WBC_E enLayer, OPTM_VDP_WBC_PARA_E enMode)
{
    ...
    WBC_DHD0_PARAUP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->WBC_DHD0_PARAUP.u32)));
...
HI_VOID  OPTM_VDP_WBC_SetSfifo (OPTM_VDP_LAYER_WBC_E enLayer, HI_U32 u32Data )
{
    ...
    WBC_DHD0_SFIFO_CTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->WBC_DHD0_SFIFO_CTRL.u32)));
    if( enLayer == OPTM_VDP_LAYER_WBC_HD0)
    {
    WBC_DHD0_SFIFO_CTRL.bits.sfifo_wr_thd = u32Data;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->WBC_DHD0_SFIFO_CTRL.u32)), WBC_DHD0_SFIFO_CTRL.u32);
