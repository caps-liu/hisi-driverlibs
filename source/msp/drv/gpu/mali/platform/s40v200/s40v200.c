...
#define GP_IRQ      (94 + 32)
#define PP0_IRQ     (94 + 32)
#define PP1_IRQ     (94 + 32)
#define PP2_IRQ     (94 + 32)
#define PP3_IRQ     (94 + 32)

#define GP_MMU_IRQ  (94 + 32)
#define PP0_MMU_IRQ (94 + 32)
#define PP1_MMU_IRQ (94 + 32)
#define PP2_MMU_IRQ (94 + 32)
#define PP3_MMU_IRQ (94 + 32)

#define MALI_GPU_RESOURCES_MALI400_MPX_PMU(base_addr, gp_irq, gp_mmu_irq, pp0_irq, pp0_mmu_irq, pp1_irq, pp1_mmu_irq, pp2_irq, pp2_mmu_irq, pp3_irq, pp3_mmu_irq) \
...
static struct mali_gpu_device_data mali_gpu_data =
{
	...
	.pmu_switch_delay = 0x1, /* do not have to be this high on FPGA, but it is good for testing to have a delay */
};
...
int mali_platform_device_register(void)
{
    ...
    int num_pp_cores = 4;
#elif defined(CHIP_TYPE_hi3716cv200es) || defined(CHIP_TYPE_hi3719mv100_a)
    int num_pp_cores = 2;
#else 
	int num_pp_cores = 0;
#endif

	struct resource mali_gpu_resources_m400_mpx[] =
	{
		MALI_GPU_RESOURCES_MALI400_MPX_PMU(MALI_BASE_ADDRESS, GP_IRQ, GP_MMU_IRQ, PP0_IRQ, PP0_MMU_IRQ, PP1_IRQ, PP1_MMU_IRQ, PP2_IRQ, PP2_MMU_IRQ, PP3_IRQ, PP3_MMU_IRQ)
	};
	...
	err = platform_device_add_resources(&mali_gpu_device, mali_gpu_resources_m400_mpx,\
			(sizeof(mali_gpu_resources_m400_mpx) / sizeof(mali_gpu_resources_m400_mpx[0]) - (4 -num_pp_cores)  *  4));
	if (0 == err)
	{
