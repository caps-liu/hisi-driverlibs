...
static HI_S32 PVR_CreatePlay(const HI_U32 file, HI_U32 *pChanId)
{
...
static HI_S32 PVR_DestroyPlay(const HI_U32 file, const HI_U32 ChanId)
{
...
static HI_S32 PVR_CreateRec(const HI_U32 file, HI_U32 *pChanId)
{
    HI_S32 ret = HI_ERR_PVR_NO_CHN_LEFT;
    HI_U32 i;
...
static HI_S32 PVR_DestroyRec(const HI_U32 file, const HI_U32 ChanId)
{
    HI_S32 ret = HI_FAILURE;
...
static HI_S32 PVR_Ioctl(struct inode *inode, struct file *file, HI_U32 cmd, HI_VOID *arg)
{
    ...
    switch (cmd)
    {
        ...
        {
            ret = PVR_CreatePlay((HI_U32)file, (HI_U32*)arg);
        ...
        {
            ret = PVR_DestroyPlay((HI_U32)file, *((HI_U32 *)arg));
        ...
        {
            ret = PVR_CreateRec((HI_U32)file, (HI_U32*)arg);
        ...
        {
            ret = PVR_DestroyRec((HI_U32)file, *((HI_U32 *)arg));
...
static int PVR_DRV_Close(struct inode *inode, struct file *file)
{
    ...
    for (i = 0; i < PVR_PLAY_MAX_CHN_NUM; i++)
    {
        PVR_DestroyPlay((HI_U32)file, i);
    }

    for (i = 0; i < PVR_REC_MAX_CHN_NUM; i++)
    {
        PVR_DestroyRec((HI_U32)file, i);
    }
