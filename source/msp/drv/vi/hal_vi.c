...
HI_VOID VI_DRV_SetWorkMode(HI_BOOL bLowDelay)
{
...
#if defined (CHIP_TYPE_hi3716cv200es)
HI_VOID VI_DRV_SetVicapIntMask(HI_U32 int_pt0_en, HI_U32 int_ch1_en, HI_U32 int_ch0_en)
{
    ...
    VICAP_INT_MASK.bits.int_ch1_en = int_ch1_en;
...
HI_VOID VI_DRV_SetChLhFirOffset(HI_U32 ChId, HI_S32 hluma_offset)
{
    ...
    {
        hluma_offset *= -1;
        CH_LHFIR_OFFSET.bits.hluma_offset = (((~hluma_offset) + 1) & 0x1FFFF);
    }
    else
    {
        /* complement */
...
HI_VOID VI_DRV_SetChLhFirCoef(HI_U32 ChId, HI_U32 phase_offset, const HI_S32 hlCoef[12])
{
    ...
    CH_LHFIR_COEF0.bits.hl_coef0 = coef_tmp[0];
    CH_LHFIR_COEF0.bits.hl_coef1 = coef_tmp[1];
    CH_LHFIR_COEF0.bits.hl_coef2 = coef_tmp[2];
    ...
    CH_LHFIR_COEF1.bits.hl_coef3 = coef_tmp[3];
    CH_LHFIR_COEF1.bits.hl_coef4 = coef_tmp[4];
    CH_LHFIR_COEF1.bits.hl_coef5 = coef_tmp[5];
    ...
    CH_LHFIR_COEF2.bits.hl_coef6 = coef_tmp[6];
    CH_LHFIR_COEF2.bits.hl_coef7 = coef_tmp[7];
    CH_LHFIR_COEF2.bits.hl_coef8 = coef_tmp[8];
    ViRegWrite(u32RegAddr, CH_LHFIR_COEF2.u32);

    u32RegAddr = VI_CH_DIFF * ChId + ((HI_U32)&(pViReg->CH_LHFIR_COEF3.u32) - (HI_U32)pViReg) + phase_offset * 0x10;
    CH_LHFIR_COEF3.u32 = ViRegRead(u32RegAddr);
    CH_LHFIR_COEF3.bits.hl_coef9  = coef_tmp[9];
    CH_LHFIR_COEF3.bits.hl_coef10 = coef_tmp[10];
    CH_LHFIR_COEF3.bits.hl_coef11 = coef_tmp[11];
    ViRegWrite(u32RegAddr, CH_LHFIR_COEF3.u32);
...
HI_VOID VI_DRV_SetChChFirCoef(HI_U32 ChId, HI_U32 phase_offset, const HI_S32 hchCoef[12])
{
    ...
    CH_CHFIR_COEF0.bits.hch_coef0 = coef_tmp[0];
    CH_CHFIR_COEF0.bits.hch_coef1 = coef_tmp[1];
    CH_CHFIR_COEF0.bits.hch_coef2 = coef_tmp[2];
    ...
    CH_CHFIR_COEF1.bits.hch_coef3 = coef_tmp[3];
    CH_CHFIR_COEF1.bits.hch_coef4 = coef_tmp[4];
    CH_CHFIR_COEF1.bits.hch_coef5 = coef_tmp[5];
    ViRegWrite(u32RegAddr, CH_CHFIR_COEF1.u32);

    u32RegAddr = VI_CH_DIFF * ChId + ((HI_U32)&(pViReg->CH_CHFIR_COEF2.u32) - (HI_U32)pViReg) + phase_offset * 0x10;
    CH_CHFIR_COEF2.u32 = ViRegRead(u32RegAddr);
    CH_CHFIR_COEF2.bits.hch_coef6 = coef_tmp[6];
    CH_CHFIR_COEF2.bits.hch_coef7 = coef_tmp[7];
    CH_CHFIR_COEF2.bits.hch_coef8 = coef_tmp[8];
    ViRegWrite(u32RegAddr, CH_CHFIR_COEF2.u32);

    u32RegAddr = VI_CH_DIFF * ChId + ((HI_U32)&(pViReg->CH_CHFIR_COEF3.u32) - (HI_U32)pViReg) + phase_offset * 0x10;
    CH_CHFIR_COEF3.u32 = ViRegRead(u32RegAddr);
    CH_CHFIR_COEF3.bits.hch_coef9  = coef_tmp[9];
    CH_CHFIR_COEF3.bits.hch_coef10 = coef_tmp[10];
    CH_CHFIR_COEF3.bits.hch_coef11 = coef_tmp[11];
    ViRegWrite(u32RegAddr, CH_CHFIR_COEF3.u32);
...
HI_VOID VI_DRV_SetChDesAddr(HI_U32 ChId, HI_U32 u32YAddr, HI_U32 u32CAddr)
{
    ...
    u32RegAddr = VI_CH_DIFF * ChId + ((HI_U32)&(pViReg->CH_DES_Y_FADDR) - (HI_U32)pViReg);
    ViRegWrite(u32RegAddr, u32YAddr);

    u32RegAddr = VI_CH_DIFF * ChId + ((HI_U32)&(pViReg->CH_DES_C_FADDR) - (HI_U32)pViReg);
...
HI_VOID VI_DRV_SetVcapInit(HI_U32 ChId, VI_DRV_CHN_STORE_INFO *pstStoreCfg)
{
    ...
    VI_DRV_SetChIntMask(ChId, 0xffffffff);
#if defined (CHIP_TYPE_hi3716cv200es)
    VI_DRV_SetWorkMode(HI_FALSE);
    VI_DRV_SetVicapIntMask(0, 0, 1);
#elif defined (CHIP_TYPE_hi3716cv200)  \
            || defined (CHIP_TYPE_hi3719cv100) || defined (CHIP_TYPE_hi3718cv100)  \
            || defined (CHIP_TYPE_hi3719mv100) || defined (CHIP_TYPE_hi3719mv100_a)\
            || defined (CHIP_TYPE_hi3718mv100)
    VI_DRV_SetWorkMode(HI_FALSE, HI_TRUE);
...
HI_VOID VI_DRV_SetChZme(HI_U32 ChId, VI_DRV_CHN_ZME_INFO * pstZmeInfo)
{
...
#if defined (CHIP_TYPE_hi3716cv200es)
    int vi_coefficient12_cubic[18][12] =                          
    {                                                                        
        { 0, 0,10, -40, 72, 428,  72, -40, 10, 0,0, 0},                      
        { 0, 0,10, -37, 59, 427,  85, -43, 11, 0,0, 0},                      
        { 0, 0, 9, -33, 47, 425,  98, -46, 12, 0,0, 0},                      
        { 0, 0, 8, -30, 35, 423, 113, -49, 12, 0,0, 0},                      
        { 0, 0, 7, -26, 24, 419, 127, -52, 13, 0,0, 0},                      
        { 0, 0, 7, -23, 13, 415, 142, -55, 13, 0,0, 0},                      
        { 0, 0, 6, -20,  4, 409, 157, -57, 13,0,0, 0},                      
        { 0, 0, 5, -16, -5, 402, 172, -59, 13, 0,0, 0},                      
        { 0, 0, 4, -13, -14, 395, 187, -60, 13,0,0, 0},                      
        { 0, 0, 4, -10, -22, 386, 203, -62, 13,0,0, 0},                      
        { 0, 0, 3,  -7, -29, 377, 218, -63, 13,0,0, 0},                      
        { 0, 0, 2,  -4, -35, 367, 233, -63, 12,0,0, 0},                      
        { 0, 0, 2,  -2, -41, 356, 249, -63, 11,0,0, 0},                      
        { 0, 0, 1,  0, -46, 345, 263, -62, 11, 0,0, 0},                      
        { 0, 0, 1,  3, -50, 332, 278, -61,  9, 0,0, 0},                      
        { 0, 0, 1,  4, -54, 320, 292, -59,  8, 0,0, 0},                      
        { 0, 0, 0,  6, -57, 307, 307, -57,  6, 0,0, 0},
    ...
    {
#if defined (CHIP_TYPE_hi3716cv200es)
        VI_DRV_SetChLhFirCoef(ChId, i, vi_coefficient12_cubic[i]);
        VI_DRV_SetChChFirCoef(ChId, i, vi_coefficient12_cubic[i]);
#elif defined (CHIP_TYPE_hi3716cv200)  \
                || defined (CHIP_TYPE_hi3719cv100) || defined (CHIP_TYPE_hi3718cv100)  \
                || defined (CHIP_TYPE_hi3719mv100) || defined (CHIP_TYPE_hi3719mv100_a)\
                || defined (CHIP_TYPE_hi3718mv100)
