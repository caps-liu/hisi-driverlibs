...
HI_S32 HI_DRV_GPIO_GetGpioNum(GPIO_GET_GPIONUM_S* GpioNum)
{
    ...
    GpioNum->u8GpioGrpNum = g_u8GpioGrpNum;
    GpioNum->u8GpioMaxNum = g_u8GpioMaxNum;
...
HI_S32 HI_DRV_GPIO_Init(void)
{
    ...
    for (i = 0; i < g_GpioNum.u8GpioMaxNum; i++)
    {
