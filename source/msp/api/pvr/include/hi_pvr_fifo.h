...
#ifdef PVR_FIFO_DIO
#define PVR_FOPEN_MODE_DATA_BOTH    (O_CREAT | O_RDWR | O_DIRECT | O_LARGEFILE | O_APPEND)
#define PVR_FOPEN_MODE_DATA_WRITE   (O_CREAT | O_WRONLY | O_DIRECT | O_LARGEFILE | O_APPEND)
#define PVR_FOPEN_MODE_DATA_READ    (O_RDONLY | O_DIRECT | O_LARGEFILE)
#else
#if 0
...
#define PVR_READ(pMem, size, file, offset)  pread(file, pMem, (size_t)(size), (off_t)(offset))
#define PVR_WRITE(pMem, size, file, offset) pwrite(file, pMem, (size_t)(size), (off_t)(offset))
