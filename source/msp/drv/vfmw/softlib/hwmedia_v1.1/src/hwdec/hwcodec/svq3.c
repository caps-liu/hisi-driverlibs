...
#include "svq1.h"
//#include "dsputil.h"     // add by lxw
//#include "bitstream.h"   // add by lxw
//#include "h264data.h"    // add by lxw
//#include "golomb.h"      // add by lxw
/**
...
static av_cold int svq3_decode_init(AVCodecContext *avctx)
{
    ...
    if (!s->context_initialized) {
        ...
        extradata = (unsigned char *)avctx->extradata[0];
        for (m = 0; m < avctx->extradata_size[0]; m++) {
