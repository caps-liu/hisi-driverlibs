...
//******************************************************************************
#ifndef __VEDU_REGR008_H__
#define __VEDU_REGR008_H__
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    VeduSliceInt          : 1   ; // [10]
        unsigned int    reserved1             : 5   ; // [15..11]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    VeduSliceIntMask      : 1   ; // [10]
        unsigned int    reserved1             : 5   ; // [15..11]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    VeduSliceIntClr       : 1   ; // [10]
        unsigned int    reserved1             : 5   ; // [15..11]
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    vencEn                : 1   ; // [1]
        unsigned int    osdEn                 : 1   ; // [2]
        unsigned int    stdmod                : 2   ; // [4..3]
        unsigned int    sliceIntEn            : 1   ; // [5]
        ...
        unsigned int    lowDlyMod             : 1   ; // [16]
        unsigned int    packageSel            : 8   ; // [24..17]
        unsigned int    regCfgMode            : 1   ; // [25]
        unsigned int    strFmt                : 2   ; // [27..26]
        unsigned int    reserved5             : 2   ; // [29..28]
...
// Define the union U_VEDU_TUNL_READ_INTVL
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    tunlReadIntvl         : 8   ; // [7..0]
        unsigned int    reaerved              : 24  ; // [31..8]
    } bits;

    // Define an unsigned member
    unsigned int    u32;

} U_VEDU_TUNL_READ_INTVL;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    MctfSmlmovEn          : 1   ; // [1]
        unsigned int    MctfBigmovEn          : 1   ; // [2]
...
#endif
        unsigned int    MctfStiLumaOrialpha   : 4   ; // [3..0]
        unsigned int    MctfSmlmovLumaOrialpha  : 4   ; // [7..4]
        unsigned int    MctfBigmovLumaOrialpha  : 4   ; // [11..8]
        unsigned int    MctfChrOrialpha       : 4   ; // [15..12]
        unsigned int    Reserved_0            : 16  ; // [31..16]
...
#endif
        unsigned int    mctfStiLumaDiffThr0   : 5   ; // [4..0]
        unsigned int    mctfStiLumaDiffThr1   : 5   ; // [9..5]
        unsigned int    mctfStiLumaDiffThr2   : 5   ; // [14..10]
...
#endif
        unsigned int    mctfSmlmovLumaDiffThr0  : 5   ; // [4..0]
        unsigned int    mctfSmlmovLumaDiffThr1  : 5   ; // [9..5]
        unsigned int    mctfSmlmovLumaDiffThr2  : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
...
// Define the union U_VEDU_MCTFCFG4
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfBigmovLumaDiffThr0  : 5   ; // [4..0]
        unsigned int    mctfBigmovLumaDiffThr1  : 5   ; // [9..5]
        unsigned int    mctfBigmovLumaDiffThr2  : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
    } bits;
...
// Define the union U_VEDU_MCTFCFG5
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfStiLumaDiffK0     : 6   ; // [5..0]
        unsigned int    mctfStiLumaDiffK1     : 6   ; // [11..6]
        unsigned int    mctfStiLumaDiffK2     : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG6
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfSmlmovLumaDiffK0  : 6   ; // [5..0]
        unsigned int    mctfSmlmovLumaDiffK1  : 6   ; // [11..6]
        unsigned int    mctfSmlmovLumaDiffK2  : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG7
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfBigmovLumaDiffK0  : 6   ; // [5..0]
        unsigned int    mctfBigmovLumaDiffK1  : 6   ; // [11..6]
        unsigned int    mctfBigmovLumaDiffK2  : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG8
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfChrDiffThr0       : 5   ; // [4..0]
        unsigned int    mctfChrDiffThr1       : 5   ; // [9..5]
        unsigned int    mctfChrDiffThr2       : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
    } bits;
...
// Define the union U_VEDU_MCTFCFG9
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfChrDiffK0         : 6   ; // [5..0]
        unsigned int    mctfChrDiffK1         : 6   ; // [11..6]
        unsigned int    mctfChrDiffK2         : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG10
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfOriRatio          : 4   ; // [3..0]
        unsigned int    mctfStiMaxRatio       : 4   ; // [7..4]
        unsigned int    mctfSmlmovMaxRatio    : 4   ; // [11..8]
        unsigned int    mctfBigmovMaxRatio    : 4   ; // [15..12]
        unsigned int    Reserved_0            : 16  ; // [31..16]
    } bits;
...
// Define the union U_VEDU_MCTFCFG11
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfStiMadiThr0       : 6   ; // [5..0]
        unsigned int    mctfStiMadiThr1       : 6   ; // [11..6]
        unsigned int    mctfStiMadiThr2       : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG12
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfSmlmovMadiThr0    : 6   ; // [5..0]
        unsigned int    mctfSmlmovMadiThr1    : 6   ; // [11..6]
        unsigned int    mctfSmlmovMadiThr2    : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG13
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfBigmovMadiThr0    : 6   ; // [5..0]
        unsigned int    mctfBigmovMadiThr1    : 6   ; // [11..6]
        unsigned int    mctfBigmovMadiThr2    : 6   ; // [17..12]
        unsigned int    Reserved_0            : 14  ; // [31..18]
    } bits;
...
// Define the union U_VEDU_MCTFCFG14
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfStiMadiK0         : 5   ; // [4..0]
        unsigned int    mctfStiMadiK1         : 5   ; // [9..5]
        unsigned int    mctfStiMadiK2         : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
    } bits;
...
// Define the union U_VEDU_MCTFCFG15
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfSmlmovMadiK0      : 5   ; // [4..0]
        unsigned int    mctfSmlmovMadiK1      : 5   ; // [9..5]
        unsigned int    mctfSmlmovMadiK2      : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
    } bits;
...
// Define the union U_VEDU_MCTFCFG16
typedef union
{
    // Define the struct bits
    struct
    {
        unsigned int    mctfBigmovMadiK0      : 5   ; // [4..0]
        unsigned int    mctfBigmovMadiK1      : 5   ; // [9..5]
        unsigned int    mctfBigmovMadiK2      : 5   ; // [14..10]
        unsigned int    Reserved_0            : 17  ; // [31..15]
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    mvdx0                 : 12  ; // [11..0]
        unsigned int    reserved1             : 4   ; // [15..12]
        unsigned int    mvdy0                 : 11  ; // [26..16]
...
typedef struct
{
    ...
    volatile U_VEDU_TUNL_READ_INTVL   VEDU_TUNL_READ_INTVL;
    volatile unsigned int           RESERVED6[17];
    ...
    volatile unsigned int           VEDU_SRCVADDR;
    ...
    volatile unsigned int           VEDU_TUNLVELL_ADDR;
    ...
    volatile unsigned int           RESERVED13_1[18];
    ...
    volatile U_VEDU_MCTFCFG4        VEDU_MCTFCFG4;
    volatile U_VEDU_MCTFCFG5        VEDU_MCTFCFG5;
    volatile U_VEDU_MCTFCFG6        VEDU_MCTFCFG6;
    volatile U_VEDU_MCTFCFG7        VEDU_MCTFCFG7;
    volatile U_VEDU_MCTFCFG8        VEDU_MCTFCFG8;
    volatile U_VEDU_MCTFCFG9        VEDU_MCTFCFG9;
    volatile U_VEDU_MCTFCFG10       VEDU_MCTFCFG10;
    volatile U_VEDU_MCTFCFG11       VEDU_MCTFCFG11;
    volatile U_VEDU_MCTFCFG12       VEDU_MCTFCFG12;
    volatile U_VEDU_MCTFCFG13       VEDU_MCTFCFG13;
    volatile U_VEDU_MCTFCFG14       VEDU_MCTFCFG14;
    volatile U_VEDU_MCTFCFG15       VEDU_MCTFCFG15;
    volatile U_VEDU_MCTFCFG16       VEDU_MCTFCFG16;
    volatile unsigned int           RESERVED14[7];
    ...
    volatile unsigned int           VEDU_BIT_LENGTH;
    volatile unsigned int           RESERVED34[3295];
