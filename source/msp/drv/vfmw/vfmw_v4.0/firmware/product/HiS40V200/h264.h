...
SINT32 StorePicInDpb(H264_CTX_S *pH264Ctx);
SINT32 InitPic(H264_CTX_S *pH264Ctx);
VOID   ReleaseNAL(SINT32 ChannelId, H264_NALU_S *p_nal);
...
UINT32 H264DEC_VDMPostProc( H264_CTX_S *pH264Ctx, SINT32 ErrRatio, SINT32 CalledByISR );
