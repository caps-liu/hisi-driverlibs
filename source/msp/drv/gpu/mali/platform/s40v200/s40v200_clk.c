...
{
	{432000, 1215, 0x148},  {400000, 1170, 0x128},  {375000, 1125, 0x120},  {345600, 1080, 0x100},
	{300000, 1020, 0x0e8},  {250000, 1000, 0x110},  {200000, 1000, 0x110},  {150000, 1000, 0x110}
};

#define DEFAULT_FREQ          345600
#define MAX_FREQ              432000
#define DEFAULT_VOLT          1080
...
int gpu_avs_init(void)
{
    u32 regval;
#if defined(CHIP_TYPE_hi3716cv200es) 
    u32 hpm_ctl = PMC_REG_ADDR_HPM3_CTL;
    u32 hpm_monitor = PMC_REG_ADDR_HPM3_MONITOR;
#else    
...
void hisi_crg_clockon(void)
{
...
#if defined(CHIP_TYPE_hi3716cv200es) || defined(CHIP_TYPE_hi3719mv100_a)
	...
	gpuclock = (gpuclock | GPU_CLOCK_PP0_ENABLE_MASK | GPU_CLOCK_PP1_ENABLE_MASK \
			| GPU_CLOCK_PP2_ENABLE_MASK | GPU_CLOCK_PP3_ENABLE_MASK);
#endif
	mali_hw_core_register_write(s_hisi_crg, CRG_REG_ADDR_SOFT_RST, gpuclock);
...
int clk_gpu_set_voltage(unsigned int volt)
{
    ...
    u8VoltReg = ((volt - VMIN) / GPU_PMU_STEP) << 2;
...
void clk_gpu_setdefault(void)
{
    ...
    clk_gpu_set_voltage(DEFAULT_VOLT);

    /* set the default frequency */
    clk_gpu_set_rate(&clk_gpu, DEFAULT_FREQ);
}
