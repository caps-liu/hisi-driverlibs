...
struct mali_session_data
{
	...
	_mali_osk_spinlock_t *pending_jobs_lock;
#endif
...
extern _mali_osk_mutex_t *mali_sessions_lock;

MALI_STATIC_INLINE void mali_session_lock(void)
{
	_mali_osk_mutex_wait(mali_sessions_lock);
}

MALI_STATIC_INLINE void mali_session_unlock(void)
{
	_mali_osk_mutex_signal(mali_sessions_lock);
}
