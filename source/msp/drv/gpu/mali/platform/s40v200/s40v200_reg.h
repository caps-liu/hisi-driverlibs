...
typedef enum {
	...
	PMC_REG_ADDR_CORE1and3_POWER    = 0x0044,
	PMC_REG_ADDR_POWER_TIME         = 0x0048, /* PERI_PMC18 */  
	PMC_REG_ADDR_CORE0and2_POWER    = 0x004c, /* PERI_PMC19 */
    ...
    PMC_REG_ADDR_HPM3_CTL           = 0x0088, /* PERI_PMC34 */
    PMC_REG_ADDR_HPM3_MONITOR       = 0x0094, /* PERI_PMC37 */
#endif    
#ifdef CHIP_TYPE_hi3716cv200es    
...
#define GPU_CORE2_POWERDOWN_REQ_MASK            (0x1 << 19)
#define GPU_CORE2_PMC_ENABLE_MASK               (0x1 << 23)
#define GPU_CORE2_WAIT_MTCMOS_ACK_MASK          (0x1 << 24)

#define GPU_CORE3_POWERDOWN_REQ_MASK            (0x1 << 19)
#define GPU_CORE3_PMC_ENABLE_MASK               (0x1 << 23)
#define GPU_CORE3_WAIT_MTCMOS_ACK_MASK          (0x1 << 24)
...
#define GPU_CORE2_POWER_STATUS_MACHINE_MASK     (0xf << 24)
#define GPU_CORE3_POWER_STATUS_MACHINE_MASK     (0xf << 28)

#define GPU_CORE0_POWERDOWN_OK                  (0x6 << 8)
#define GPU_CORE1_POWERDOWN_OK                  (0x6 << 12)
#define GPU_CORE2_POWERDOWN_OK                  (0x6 << 24)
#define GPU_CORE3_POWERDOWN_OK                  (0x6 << 28)

#define GPU_CORE0_POWERUP_OK                    (0x0)
#define GPU_CORE1_POWERUP_OK                    (0x0)
#define GPU_CORE2_POWERUP_OK                    (0x0)
#define GPU_CORE3_POWERUP_OK                    (0x0)
