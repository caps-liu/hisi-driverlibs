...
typedef void (*VP56ParseVectorAdjustment)(VP56Context *s,
                                          VP56mv *vect);
typedef int  (*VP56Adjust)(int v, uint32_t t);
...
typedef int  (*VP56ParseHeader)(VP56Context *s, const uint8_t *buf,
                                int buf_size, int *golden_frame,int *key_frame);
...
#define INTERNAL_BUFFER_SIZE 32
	...
	int little_10;
	int little_64;
	uint8_t EobOffsetTable[64];
};


/*void*/ int vp56_init(AVCodecContext *avctx, int flip, int has_alpha);
