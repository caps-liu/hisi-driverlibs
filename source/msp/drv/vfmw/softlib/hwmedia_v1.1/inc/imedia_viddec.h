...
typedef struct STRU_IVIDDEC_PARAMS
{
    ...
    INT32  iFlags;             /**< 算法通道常用标记组合，建议值：0，详情见imedia_common.h中模块公共常用标记
									...
									第3比特： IMEDIA_FLAG_DISABLE_ARM         通道性能统计使能标记
...
typedef struct STRU_IVIDDEC_OUT_ARGS 
{
    ...
    UINT32 uiBytesConsumed;            /**< 已解析码流的字节数, 若该值为0表明解码器内部缓存不够，需要应用层重复解码该批数据*/
...
typedef struct STRU_IVIDDEC_MEMORY_INFO
{
    ...
    ENUM_IVIDEO_COLOR_SPACE_TYPE eColorFormat;		/**< 图像的色度空间：422、420等，目前仅420有效，保留字段 */
