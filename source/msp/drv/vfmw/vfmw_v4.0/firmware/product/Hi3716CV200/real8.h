...
* Date: $2009/07/13$
* Revision: $v1.0$
* Purpose: real8 decoder header file
*
*
* Change History:
*
...
#define REAL8_MAX_SLOT_NUM                       (64*2)
...
#define REAL8_SLC_DN_MSG_SLOT_FULL_THRESHOLD     (REAL8_MAX_SLOT_NUM-4)  // 60
...
typedef struct
{
    ...
    //repair msg slot
    PHYADDR    rpmsg_phy_addr;

    //pic down msg slot
    PHYADDR    picdnmsg_phy_addr;

    //slice down msg slot
    PHYADDR    slcdnmsg_phy_addr;
...
//  PHYADDR    pmv_colmb_phy_addr;
    ...
    UINT32     ddr_stride;
    PHYADDR    image_phy_addr[REAL8_MAXIMUM_IMAGE_NUM];
