...
\param[in] phAenc                    Obtain the handle of the audio encoder. CNcomment:得到音频编码器句柄 CNend
...
/**
\brief Attach audio encoder with audio track,reserved. CNcomment:绑定音频编码器和音频Track 通路, 预留 CNend
\attention \n
...
/**
\brief Detach audio encoder with audio track, reserved. CNcomment:解除音频编码器和音频Track 通路的绑定, 预留 CNend
\attention \n
