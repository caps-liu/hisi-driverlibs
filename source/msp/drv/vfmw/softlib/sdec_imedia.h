...
* Date     : $2010/09/08$
* Revision : $v1.1$
* Purpose  : H.263 soft-decoder adaptor head file.
*
* Change History:
*
* Date                       Author                          Change
...
#define  iMediaSDEC_VIR_2_PHY(vir)  ((pVfmwToSvdecFun->pfnVfmwMemVir2Phy)(vir))//(MEM_Vir2Phy(vir))
#define  iMediaSDEC_PHY_2_VIR(phy)  ((pVfmwToSvdecFun->pfnVfmwMemPhy2Vir)(phy))//(MEM_Phy2Vir(phy))
