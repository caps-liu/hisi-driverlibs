...
static void vector_fmul_add_add_3dnow(float *dst, const float *src0, const float *src1,
    ...
    if(step == 2 && src3 == 0){
		...
		/*屏蔽此代码 编译不通过 x00141957 20101230*/
...
#endif
	/*x00141957 2010 1230屏蔽此代码 编译不通过*/
...
#endif
		/*x00141957 20101230 屏蔽此代码 编译不通过*/
//        ff_vector_fmul_window_c(dst, src0, src1, win, add_bias, len);
;
}
...
/*vp6不再采用idct_put以及idct_add x00141957 2010 1130*/			
#if 0			
...
#define SET_QPEL_FUNCS(PFX, IDX, SIZE, CPU) \
	    ...
	    {
		    c->weight_h264_pixels_tab[0]= ff_h264_weight_16x16_sse4;
	            c->weight_h264_pixels_tab[1]= ff_h264_weight_16x8_sse4;
	            c->weight_h264_pixels_tab[2]= ff_h264_weight_8x16_sse4;
	            c->weight_h264_pixels_tab[3]= ff_h264_weight_8x8_sse4;
	            c->weight_h264_pixels_tab[4]= ff_h264_weight_8x4_sse4;
	            c->weight_h264_pixels_tab[5]= ff_h264_weight_4x8_sse4;
	            c->weight_h264_pixels_tab[6]= ff_h264_weight_4x4_sse4;
	            c->weight_h264_pixels_tab[7]= ff_h264_weight_4x2_sse4;
	
	            c->biweight_h264_pixels_tab[0]= ff_h264_biweight_16x16_sse4;
	            c->biweight_h264_pixels_tab[1]= ff_h264_biweight_16x8_sse4;
	            c->biweight_h264_pixels_tab[2]= ff_h264_biweight_8x16_sse4;
	            c->biweight_h264_pixels_tab[3]= ff_h264_biweight_8x8_sse4;
	            c->biweight_h264_pixels_tab[4]= ff_h264_biweight_8x4_sse4;
	            c->biweight_h264_pixels_tab[5]= ff_h264_biweight_4x8_sse4;
	            c->biweight_h264_pixels_tab[6]= ff_h264_biweight_4x4_sse4;
	            c->biweight_h264_pixels_tab[7]= ff_h264_biweight_4x2_sse4;
	    }
	    else
	    {
...
//            av_log(NULL,AV_LOG_WARNING,"Come in ff_x264_deblock_v_luma_intra_mmxext\n");
#endif
            if( mm_flags&FF_MM_SSE2 )
            {
