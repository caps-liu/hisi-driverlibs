...
/* 将AV_LOG_INFO的宏定义改为2，将AV_LOG_DEBUG的信息改为3 */
...
void av_log_set_callback(void (*)(const char *, int, const char *, void*, int, const char*, va_list));
void av_log_default_callback(const char *, int, const char *, void*, int, const char* fmt, va_list);

#define av_log(ptr, level, ...) av_log_hw(__FILE__, __LINE__, __FUNCTION__, ptr, level, ##__VA_ARGS__)
#else
