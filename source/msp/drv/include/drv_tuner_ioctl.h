...
typedef struct _TUNER_OPS_S
{
    ...
    HI_S32 (*tuner_data_sample)(HI_U32 u32TunerPort, TUNER_DATA_SRC_E enDataSrc, HI_U32 u32DataLen, HI_UNF_TUNER_SAMPLE_DATA_S *pstData);
...
#define TUNER_SETPLPNO_CMD _IOW(HI_TUNER_IOC_MAGIC, 32, TUNER_DATA_S) 
