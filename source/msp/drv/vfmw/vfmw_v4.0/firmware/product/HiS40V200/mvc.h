...
typedef struct
{
    ...
    SINT32 view_id;
    UINT32 temporal_id;
    UINT32 anchor_pic_flag;
    UINT32 inter_view_flag;
    UINT32 reserved_one_bit;
} MVC_NALUMVCEXT_S;
...
typedef struct
{
    UINT32  vui_mvc_num_ops_minus1;//1024
    UINT32  vui_mvc_temporal_id[64];
    UINT32  vui_mvc_num_target_output_views_minus1[64];
    UINT32  vui_mvc_view_id[64][64];
    UINT32  vui_mvc_timing_info_present_flag[64];
    UINT32  vui_mvc_num_units_in_tick[64];
    UINT32  vui_mvc_time_scale[64];
    UINT32  vui_mvc_fixed_frame_rate_flag[64];
    UINT32  vui_mvc_nal_hrd_parameters_present_flag[64];
    MVC_HRD_PARAMETERS_S  mvc_nal_hrd_parameters[64];
    UINT32  vui_mvc_vcl_hrd_parameters_present_flag[64];
    MVC_HRD_PARAMETERS_S  mvc_vcl_hrd_parameters[64];
    UINT32  vui_mvc_low_delay_hrd_flag[64];
    UINT32  vui_mvc_pic_struct_present_flag[64];
} MVCVUI_SUBSPS_S;
...
#if 0	
    UINT32  level_idc[64];
    UINT32  num_applicable_ops_minus1[64];
    UINT32  applicable_op_temporal_id[64][1024];
    UINT32  applicable_op_num_target_views_minus1[64][1024];
    UINT32  applicable_op_target_view_id[64][1024][1024];
    UINT32  applicable_op_num_views_minus1[64][1024];
#endif
#if 0	
    UINT32  *level_idc;
    UINT32  *num_applicable_ops_minus1;
    UINT32  **applicable_op_temporal_id;
    UINT32  **applicable_op_num_target_views_minus1;
    UINT32  ***applicable_op_target_view_id;
    UINT32  **applicable_op_num_views_minus1;
#endif
...
{   
    ...
    UINT32  apc_idc;
    SINT32  as_first_out;    //mvc为了假装第一帧快速输出，同时可以判断IDRFOUND的置位时机
    SINT32 svc_extension_flag;
    SINT32 view_id;
    UINT32 voidx;
    UINT32 anchor_pic_flag[2];
    UINT32 inter_view_flag[2];
...
typedef struct
{
    ...
    MVC_SUBSPS_S SUBSPS[32];  //yyc test
    UINT32 TotalSUBSPS;
    ...
    MVC_PPS_S *pPPS;
    UINT32 Init_Subsps_Flag;
    UINT32 CurrDPBSize;
    MVC_FRAMESTORE_S InterviewListX[2][MVC_MAX_NUM_VIEWS];
    MVC_OUTFRMBUFFER_S OutFRMBuffer;
    UINT32 PicCount;
    /*END*/
