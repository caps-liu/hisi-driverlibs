...
#define WDIOC_SETOPTIONS _IOR(WATCHDOG_IOCTL_BASE, 4, WDG_OPTION_S)
#define WDIOC_KEEPALIVE _IOR(WATCHDOG_IOCTL_BASE, 5, int)
#define WDIOC_SETTIMEOUT _IOWR(WATCHDOG_IOCTL_BASE, 6, WDG_TIMEOUT_S)
#define WDIOC_GETTIMEOUT _IOR(WATCHDOG_IOCTL_BASE, 7, WDG_TIMEOUT_S)
